...
function (_Component) {
  ...
  _createClass(_default, [{
    ...
    value: function render() {
      ...
      }, this.props.categories.name.en.map(function (item, i) {
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                _context.next = 4;
                return __WEBPACK_IMPORTED_MODULE_3__common_Util__["a" /* default */].fetchCommerceCategories(categoryId);
...
//# sourceMappingURL=5.f9356d3cd789b0138821.hot-update.js.map