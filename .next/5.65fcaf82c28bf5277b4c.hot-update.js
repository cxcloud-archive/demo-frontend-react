...
function (_Component) {
  ...
  _createClass(_default, [{
    ...
    value: function render() {
      console.log(this.props.commerceResults);
    ...
    value: function () {
      ...
      __WEBPACK_IMPORTED_MODULE_0__babel_runtime_regenerator___default.a.mark(function _callee(_ref) {
        var query, req, userId, users, user, commerceId, commerce, commerceResults, productId, product, recommendedProductsId, recommendedProducts;
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              ...
              case 4:
                ...
                commerceId = __WEBPACK_IMPORTED_MODULE_9_lodash___default.a.get(query, 'id');
                _context.next = 9;
                return __WEBPACK_IMPORTED_MODULE_6__common_Util__["a" /* default */].fetchCommerce(commerceId);

              case 9:
                commerce = _context.sent;
                commerceResults = commerce[0]; //const commerce = users.items[0].fields;
...
//# sourceMappingURL=5.65fcaf82c28bf5277b4c.hot-update.js.map