...
function (_Component) {
  ...
  _createClass(_default, [{
    ...
    value: function render() {
      ...
      })(["margin:0px auto 2em auto;padding-bottom:5em;border-bottom:1px solid rgba(211,183,86,1);display:flex;flex-direction:row;justify-content:center;flex-wrap:wrap;:active{color:rgba(211,183,86,1);}:focus{color:red;}:target{color:red;}:nth-child(2n){flex-grow:1;}"]);
      var CategoryName = __WEBPACK_IMPORTED_MODULE_5_styled_components__["a" /* default */].button.withConfig({
        displayName: "CategoriesList__CategoryName",
        componentId: "o6txje-2"
      })(["width:8em;font-size:22px;height:2em;text-align:center;margin:18px;border:1px solid rgba(211,183,86,1);text-decoration:none;text-transform:uppercase;color:#4a4a4a;border-radius:2px;:hover{background-color:rgba(211,183,86,1);color:whitesmoke;}"]);
...
function (_Component) {
  ...
  _createClass(_default, [{
    ...
    key: "render",
    value: function render() {
      var Wrapper = __WEBPACK_IMPORTED_MODULE_4_styled_components__["a" /* default */].div.withConfig({
...
function (_Component) {
  ...
  _createClass(_default, [{
    ...
    value: function render() {
      ...
      var Logo = __WEBPACK_IMPORTED_MODULE_3_styled_components__["a" /* default */].div.withConfig({
...
/* harmony default export */ __webpack_exports__["a"] = (function (_ref) {
  ...
  var global = __WEBPACK_IMPORTED_MODULE_3_styled_components__["a" /* default */].div.withConfig({
    displayName: "Layout__global",
    componentId: "sc-1c610dc-0"
  })(["font-family:Verdana,Geneva,Tahoma,sans-serif;color:#4a4a4a;"]);
  var button = __WEBPACK_IMPORTED_MODULE_3_styled_components__["a" /* default */].button.withConfig({
  ...
  var title = __WEBPACK_IMPORTED_MODULE_3_styled_components__["a" /* default */].h1.withConfig({
  ...
  var big = __WEBPACK_IMPORTED_MODULE_3_styled_components__["a" /* default */].h1.withConfig({
    displayName: "Layout__big",
    componentId: "sc-1c610dc-3"
  })(["font-size:20px;"]);
  var medium = __WEBPACK_IMPORTED_MODULE_3_styled_components__["a" /* default */].p.withConfig({
    displayName: "Layout__medium",
    componentId: "sc-1c610dc-4"
  })(["font-size:16px;"]);
  var small = __WEBPACK_IMPORTED_MODULE_3_styled_components__["a" /* default */].p.withConfig({
    displayName: "Layout__small",
    componentId: "sc-1c610dc-5"
  })(["font-size:12px;"]);
  var light = __WEBPACK_IMPORTED_MODULE_3_styled_components__["a" /* default */].p.withConfig({
    displayName: "Layout__light",
    componentId: "sc-1c610dc-6"
  })(["font-weight:200;"]);
  var bold = __WEBPACK_IMPORTED_MODULE_3_styled_components__["a" /* default */].p.withConfig({
